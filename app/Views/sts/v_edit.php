    ...
    <div class="col-md-6">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <?php } ?>
                <?php echo form_open('sts/update/' . $sts['id_sts']);
                ?>

                <div class="form-group">
                    <label>Tanggal</label>
                    <input name="tanggal" type="date" value="<?= $sts['tanggal']; ?>" class="form-control" required>
                </div>

                <div class="form-group">
                    <label>Nama Wajib Pajak</label>
                    <input name="nama_wajib" value="<?= $sts['nama_wajib'] ?>" class="form-control" placeholder="Nama Wajib Pajak" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="ket_tempat" value="<?= $sts['ket_tempat'] ?>" class="form-control" placeholder="Alamat Tempat" required>
                </div>

                <div class="form-group">
                    <label>Jumlah Harga Pajak</label>
                    <input name="jumlah_pajak" value="<?= $sts['jumlah_pajak'] ?>" class="form-control" placeholder="Jumlah Harga Pajak" required>
                </div>

                <div class="form-group">
                    <button type="submit" class="btn btn-primary">Simpan</button>
                    <a href="<?= base_url('sts') ?>" class="btn btn-success">Kembali</a>
                </div>
