...
<body>
    ...
    <div class="col-12">
        <h2 class="text-center">Laporan Pajak Restoran</h2>
        <table class="table" border="1">
            ...
            <tbody>
                ...
                foreach ($sts as $key => $value) {
                    ...
                    <tr>
                        <td width="50px"><?= $no++; ?></td>
                        <td width="120px"><?= $value['tanggal']; ?></td>
                        <td width="160px"><?= $value['nama_wajib']; ?></td>
                        <td width="120px"><?= $value['nama_kategori']; ?></td>
