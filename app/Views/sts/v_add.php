            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select name="nama_kategori" class="form-control">
                        ...
                        <option value="Pajak Penerangan Jalan (PPJ-PLN)">Pajak Penerangan Jalan (PPJ-PLN)</option>
                ...
                <div class="form-group">
                    ...
                    <input name="ket_tempat" class="form-control" placeholder="Alamat Tempat" required>
                </div>

                <div class="form-group">
                    <label>Jumlah Harga Pajak</label>
                    <input name="jumlah_pajak" class="form-control" placeholder="Jumlah Harga Pajak" required>
                </div>
